...
namespace adventofcode2017
{
    ...
    public class Day8Part2
    {
        ...
        private class Program { 
            ...
            private static void EvaluateModifyExpression(Register target, int modifyValue, ModifyOperation operation)
            {
                switch (operation)
                {
            ...
            private static bool EvaluateCompareExpression(Register compareTarget, int compareValue, CompareOperation operation)
            {
                switch (operation)
                {
            ...
            private static ModifyOperation ParseModifyOperation(string modifyOperation)
            {
            ...
            private static CompareOperation parseOperation(string operation)
            {
                switch (operation) { 
                    case ">": 
